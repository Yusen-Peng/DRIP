#!/bin/bash
#SBATCH --job-name=June30_LLaVA_7B_Perceiver_10x_pretrain
#SBATCH --output=June30_LLaVA_7B_Perceiver_10x_pretrain.txt
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_Perceiver_10x_pretrain \
    --num_train_epochs 1 \
