#!/bin/bash
#SBATCH --job-name=May1_7B_DRIP_4x_pretrain_temperature05_round2
#SBATCH --output=May1_7B_DRIP_4x_pretrain_temperature05_round2.txt
#SBATCH --time=1:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_DRIP_4x_pretrain_temp05 \
    --num_train_epochs 1 \
