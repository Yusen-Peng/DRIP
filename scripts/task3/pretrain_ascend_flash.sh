#!/bin/bash
#SBATCH --job-name=May20_7B_Fixed_10x_pretrain_continue_2
#SBATCH --output=May20_7B_Fixed_10x_pretrain_continue_2.txt
#SBATCH --time=1:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_Fixed_10x_pretrain \
    --num_train_epochs 1 \
