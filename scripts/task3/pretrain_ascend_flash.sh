#!/bin/bash
#SBATCH --job-name=Apr23_7B_DRIP_4x_pretrain_round1
#SBATCH --output=Apr23_7B_DRIP_4x_pretrain_round1.txt
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_DRIP_4x_pretrain \
    --num_train_epochs 1 \
