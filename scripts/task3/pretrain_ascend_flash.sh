#!/bin/bash
#SBATCH --job-name=Aug12_LLaVA_7B_DRIP_10x_pretrain_SCALE
#SBATCH --output=Aug12_LLaVA_7B_DRIP_10x_pretrain_SCALE.txt
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_DRIP_10x_pretrain_SCALE \
    --num_train_epochs 1 \
