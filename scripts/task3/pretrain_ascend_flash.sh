#!/bin/bash
#SBATCH --job-name=May3_7B_Fixed_4x_pretrain
#SBATCH --output=May3_7B_Fixed_4x_pretrain.txt
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_Fixed_4x_pretrain \
    --num_train_epochs 1 \
