#!/bin/bash
#SBATCH --job-name=May8_7B_DRIP_4x_pretrain_temp001
#SBATCH --output=May8_7B_DRIP_4x_pretrain_temp001.txt
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_DRIP_4x_pretrain_temp001 \
    --num_train_epochs 1 \
