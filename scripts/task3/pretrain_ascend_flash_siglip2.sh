#!/bin/bash
#SBATCH --job-name=July26_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_pretrain_temp10
#SBATCH --output=July26_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_pretrain_temp10.txt
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_SigLIP_HF_v2_DRIP_10x_pretrain_temp10 \
    --num_train_epochs 1 \
