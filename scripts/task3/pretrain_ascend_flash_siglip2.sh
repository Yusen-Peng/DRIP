#!/bin/bash
#SBATCH --job-name=Aug15_LLaVA_7B_SigLIP_HF_v2_DRIP_4x_pretrain_temp001_new_downsample
#SBATCH --output=Aug15_LLaVA_7B_SigLIP_HF_v2_DRIP_4x_pretrain_temp001_new_downsample.txt
