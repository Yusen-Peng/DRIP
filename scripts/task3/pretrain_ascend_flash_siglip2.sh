#!/bin/bash
#SBATCH --job-name=July25_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_pretrain_temp08
#SBATCH --output=July25_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_pretrain_temp08.txt
...
#SBATCH --exclude=a0022,a0020,a0021,a0019,a0014
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_SigLIP_HF_v2_DRIP_10x_pretrain_temp08 \
    --num_train_epochs 1 \
