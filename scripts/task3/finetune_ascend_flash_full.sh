#!/bin/bash
#SBATCH --job-name=June5_LLaVA_7B_DRIP_4x_Hnet_ablation_train_full
#SBATCH --output=June5_LLaVA_7B_DRIP_4x_Hnet_ablation_train_full.txt
...
torchrun --standalone --nproc_per_node=4 --master_port=$MASTER_PORT src/task3_llava.py \
    ...
    --tf32 True \
    --bf16 True \
    --pretrain_mm_mlp_adapter /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_DRIP_4x_Hnet_ablation_pretrain/mm_projector.bin \
    --mm_vision_select_layer -1 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_DRIP_4x_Hnet_ablation_train_full \
    --num_train_epochs 1 \
