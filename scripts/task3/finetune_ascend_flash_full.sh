#!/bin/bash
#SBATCH --job-name=June1_LLaVA_7B_Fixed_4x_second_to_last_train_full
#SBATCH --output=June1_LLaVA_7B_Fixed_4x_second_to_last_train_full.txt
...
torchrun --standalone --nproc_per_node=4 --master_port=$MASTER_PORT src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_Fixed_4x_second_to_last_train_full \
    --num_train_epochs 1 \
