...
#     --dataset_split test \
#     --cache_dir /fs/scratch/PAS2836/shared_LLaVA_eval/ocrbenchv2 \
#     --output_folder /fs/scratch/PAS2836/shared_LLaVA_eval/ocrbenchv2/results \
#     --save_name ${VERSION} \
#     --num_workers 1 \
#     --temperature 0 \
#     --conv_mode vicuna_v1
...
python src/OCRBenchv2_eval/json_merge.py \
    --pred /fs/scratch/PAS2836/shared_LLaVA_eval/ocrbenchv2/results/${VERSION}.json \
    --out /fs/scratch/PAS2836/shared_LLaVA_eval/ocrbenchv2/results/${VERSION}_merged.json

#### step2: run evaluation

export NLTK_DATA=/fs/scratch/PAS2836/yusenpeng_dataset/nltk_data
mkdir -p /fs/scratch/PAS2836/shared_LLaVA_eval/ocrbenchv2/scores

python src/OCRBenchv2_eval/eval.py \
    --input_path /fs/scratch/PAS2836/shared_LLaVA_eval/ocrbenchv2/results/${VERSION}_merged.json \
    --output_path /fs/scratch/PAS2836/shared_LLaVA_eval/ocrbenchv2/scores/${VERSION}_scores.json

python src/OCRBenchv2_eval/get_score.py \
    --json_file /fs/scratch/PAS2836/shared_LLaVA_eval/ocrbenchv2/scores/${VERSION}_scores.json
