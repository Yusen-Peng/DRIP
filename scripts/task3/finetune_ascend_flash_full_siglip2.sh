#!/bin/bash
#SBATCH --job-name=July27_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_train_full_temp10
#SBATCH --output=July27_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_train_full_temp10.txt
...
torchrun --standalone --nproc_per_node=4 --master_port=$MASTER_PORT src/task3_llava.py \
    ...
    --tf32 True \
    --bf16 True \
    --pretrain_mm_mlp_adapter /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_SigLIP_HF_v2_DRIP_10x_pretrain_temp10/mm_projector.bin \
    --mm_vision_select_layer -1 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_SigLIP_HF_v2_DRIP_10x_train_full_temp10 \
    --num_train_epochs 1 \
