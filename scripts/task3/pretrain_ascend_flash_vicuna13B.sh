#!/bin/bash
#SBATCH --job-name=Jun6_LLaVA_Vicuna_13B_pretrain_TEST
#SBATCH --output=Jun6_LLaVA_Vicuna_13B_pretrain_TEST.txt
#SBATCH --time=1:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/Vicuna_13B_pretrain \
    --num_train_epochs 1 \
