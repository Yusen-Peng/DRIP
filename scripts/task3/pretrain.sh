#!/bin/bash
#SBATCH --job-name=Oct28_pretrain_openai_vit
#SBATCH --output=Oct28_pretrain_openai_vit.txt
...
deepspeed src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/ViT-base-pretrain-openai \
    --num_train_epochs 1 \
