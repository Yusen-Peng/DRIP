#!/bin/bash
#SBATCH --job-name=June15_LLaVA_7B_SigLIP_512_DRIP_10x_train_all
#SBATCH --output=June15_LLaVA_7B_SigLIP_512_DRIP_10x_train_all.txt
...
#SBATCH --exclude=a0010,a0009,a0011
...
torchrun --standalone --nproc_per_node=4 --master_port=$MASTER_PORT src/task3_llava.py \
    ...
    --tf32 True \
    --bf16 True \
    --pretrain_mm_mlp_adapter /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_SigLIP_pretrain_512_DRIP_10x/mm_projector.bin \
    --mm_vision_select_layer -1 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_SigLIP_512_DRIP_10x_train_all \
    --num_train_epochs 1 \
