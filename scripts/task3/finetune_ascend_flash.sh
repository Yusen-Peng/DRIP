#!/bin/bash
#SBATCH --job-name=May19_7B_DRIP_10x_finetune
#SBATCH --output=May19_7B_DRIP_10x_finetune.txt
...
deepspeed src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_DRIP_10x_finetune \
    --num_train_epochs 1 \
