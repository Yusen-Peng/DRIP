#!/bin/bash
#SBATCH --job-name=Jun18_LLaVA_Qwen2.5-14B-Instruct_DRIP_10x_pretrain
#SBATCH --output=Jun18_LLaVA_Qwen2.5-14B-Instruct_DRIP_10x_pretrain.txt
...
deepspeed --num_gpus=1 src/task3_llava.py \
    ...
    --output_dir /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_Qwen2.5-14B-Instruct_DRIP_10x_pretrain \
    --num_train_epochs 1 \
