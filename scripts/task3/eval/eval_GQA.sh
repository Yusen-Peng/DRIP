#!/bin/bash
#SBATCH --job-name=0628_GQA_LLaVA_7B_FLASH_finetune_PruneSID_10x_full_second
#SBATCH --output=0628_GQA_LLaVA_7B_FLASH_finetune_PruneSID_10x_full_second.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_FLASH_finetune_PruneSID_10x_full_second.jsonl
