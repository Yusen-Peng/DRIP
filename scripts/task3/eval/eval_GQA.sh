#!/bin/bash
#SBATCH --job-name=Apr29_GQA_LLaVA_7B_DRIP_4x_finetune_train_lora
#SBATCH --output=Apr29_GQA_LLaVA_7B_DRIP_4x_finetune_train_lora.txt
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_DRIP_4x_finetune_train_lora.jsonl
