#!/bin/bash
#SBATCH --job-name=0615_GQA_LLaVA_7B_DRIP_4x_ratio_ablation_train_full
#SBATCH --output=0615_GQA_LLaVA_7B_DRIP_4x_ratio_ablation_train_full.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_DRIP_4x_ratio_ablation_train_full.jsonl
