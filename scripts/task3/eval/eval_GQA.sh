#!/bin/bash
#SBATCH --job-name=May21_GQA_LLaVA_7B_DRIP_10x_finetune_train_lora
#SBATCH --output=May21_GQA_LLaVA_7B_DRIP_10x_finetune_train_lora.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_DRIP_10x_finetune_train_lora.jsonl
