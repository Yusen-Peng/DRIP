#!/bin/bash
#SBATCH --job-name=May25_GQA_LLaVA_7B_Fixed_20x_finetune_train_full
#SBATCH --output=May25_GQA_LLaVA_7B_Fixed_20x_finetune_train_full.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_Fixed_20x_finetune_train_full.jsonl
