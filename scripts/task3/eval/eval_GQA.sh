#!/bin/bash
#SBATCH --job-name=0702_GQA_LLaVA_7B_SigLIP_HF_v2_Fixed_8x_train_full_FREE
#SBATCH --output=0702_GQA_LLaVA_7B_SigLIP_HF_v2_Fixed_8x_train_full_FREE.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_SigLIP_HF_v2_Fixed_8x_train_full_FREE.jsonl
