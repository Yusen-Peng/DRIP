#!/bin/bash
#SBATCH --job-name=May12_GQA_LLaVA_7B_DRIP_8x_pretrain
#SBATCH --output=May12_GQA_LLaVA_7B_DRIP_8x_pretrain.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_DRIP_8x_pretrain.jsonl
