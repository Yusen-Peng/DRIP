#!/bin/bash
#SBATCH --job-name=0722_GQA_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_temp08_new_downsample_train_full
#SBATCH --output=0722_GQA_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_temp08_new_downsample_train_full.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_SigLIP_HF_v2_DRIP_10x_temp08_new_downsample_train_full.jsonl

python src/model_vqa_loader.py \
    --model-path /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_SigLIP_HF_v2_DRIP_10x_temp08_new_downsample_train_full \
