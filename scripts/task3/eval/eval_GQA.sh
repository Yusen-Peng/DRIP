#!/bin/bash
#SBATCH --job-name=May23_GQA_LLaVA_7B_PruMerge_4x_finetune_train_full
#SBATCH --output=May23_GQA_LLaVA_7B_PruMerge_4x_finetune_train_full.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_PruMerge_4x_finetune_train_full.jsonl
