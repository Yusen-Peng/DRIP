#!/bin/bash
#SBATCH --job-name=May24_GQA_LLaVA_7B_Fixed_500x_pretrain
#SBATCH --output=May24_GQA_LLaVA_7B_Fixed_500x_pretrain.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_Fixed_500x_pretrain.jsonl
