#!/bin/bash
#SBATCH --job-name=0702_GQA_LLaVA_7B_Perceiver_10x_train_all_second
#SBATCH --output=0702_GQA_LLaVA_7B_Perceiver_10x_train_all_second.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_Perceiver_10x_train_all_second.jsonl
