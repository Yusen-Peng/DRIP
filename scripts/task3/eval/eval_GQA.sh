#!/bin/bash
#SBATCH --job-name=May8_GQA_LLaVA_7B_PruMerge_4x_finetune
#SBATCH --output=May8_GQA_LLaVA_7B_PruMerge_4x_finetune.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_PruMerge_4x_finetune.jsonl
