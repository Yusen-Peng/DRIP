#!/bin/bash
#SBATCH --job-name=0812_GQA_LLaVA_7B_DRIP_4x_to_10x
#SBATCH --output=0812_GQA_LLaVA_7B_DRIP_4x_to_10x.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_DRIP_4x_to_10x.jsonl
