#!/bin/bash
#SBATCH --job-name=Apr26_GQA_LLaVA_7B_FLASH_finetune_ALL_ONCE_lora
#SBATCH --output=Apr26_GQA_LLaVA_7B_FLASH_finetune_ALL_ONCE_lora.txt
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_FLASH_finetune_ALL_ONCE_lora.jsonl
