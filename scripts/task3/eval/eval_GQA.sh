#!/bin/bash
#SBATCH --job-name=May1_GQA_LLaVA_7B_DRIP_4x_pretrain_last_force
#SBATCH --output=May1_GQA_LLaVA_7B_DRIP_4x_pretrain_last_force.txt
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_DRIP_4x_pretrain_last_force.jsonl
