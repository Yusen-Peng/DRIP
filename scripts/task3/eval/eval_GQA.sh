#!/bin/bash
#SBATCH --job-name=0702_GQA_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_train_full_temp001
#SBATCH --output=0702_GQA_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_train_full_temp001.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_SigLIP_HF_v2_DRIP_10x_train_full_temp001.jsonl
