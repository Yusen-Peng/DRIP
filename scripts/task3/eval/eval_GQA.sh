#!/bin/bash
#SBATCH --job-name=0722_GQA_LLaVA_7B_SigLIP_HF_v2_DRIP_8x_temp08_new_downsample_train_full
#SBATCH --output=0722_GQA_LLaVA_7B_SigLIP_HF_v2_DRIP_8x_temp08_new_downsample_train_full.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_SigLIP_HF_v2_DRIP_8x_temp08_new_downsample_train_full.jsonl
