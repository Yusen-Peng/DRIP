#!/bin/bash
#SBATCH --job-name=0628_GQA_LLaVA_7B_FLASH_finetune_PruneSID_4x_full
#SBATCH --output=0628_GQA_LLaVA_7B_FLASH_finetune_PruneSID_4x_full.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_FLASH_finetune_PruneSID_4x_full.jsonl
