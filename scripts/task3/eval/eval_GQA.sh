#!/bin/bash
#SBATCH --job-name=0702_GQA_LLaVA_7B_Perceiver_10x_train_all
#SBATCH --output=0702_GQA_LLaVA_7B_Perceiver_10x_train_all.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_Perceiver_10x_train_all.jsonl
