#!/bin/bash
#SBATCH --job-name=0616_GQA_LLaVA_Qwen2.5-14B-Instruct_train_full
#SBATCH --output=0616_GQA_LLaVA_Qwen2.5-14B-Instruct_train_full.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_Qwen2.5-14B-Instruct_train_full.jsonl
