#!/bin/bash
#SBATCH --job-name=May22_GQA_LLaVA_7B_FLASH_finetune_ALL_ONCE_full
#SBATCH --output=May22_GQA_LLaVA_7B_FLASH_finetune_ALL_ONCE_full.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_FLASH_finetune_ALL_ONCE_full.jsonl
