#!/bin/bash
#SBATCH --job-name=May22_GQA_LLaVA_7B_Fixed_8x_finetune_train_full
#SBATCH --output=May22_GQA_LLaVA_7B_Fixed_8x_finetune_train_full.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_Fixed_8x_finetune_train_full.jsonl

python src/model_vqa_loader.py \
    --model-path /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_Fixed_8x_finetune_train_full \
