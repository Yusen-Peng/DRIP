#!/bin/bash
#SBATCH --job-name=0628_GQA_LLaVA_7B_SigLIP_HF_finetune_full
#SBATCH --output=0628_GQA_LLaVA_7B_SigLIP_HF_finetune_full.log
...
OUTPUT_FILE=$OUTPUT_DIR/LLaVA_7B_SigLIP_HF_finetune_full.jsonl
