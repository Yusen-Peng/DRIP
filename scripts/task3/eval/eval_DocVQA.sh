#!/bin/bash
#SBATCH --job-name=0812_DocVQA_LLaVA_7B_SigLIP_HF_v2_DRIP_4x_temp15_new_downsample_train_full
#SBATCH --output=0812_DocVQA_LLaVA_7B_SigLIP_HF_v2_DRIP_4x_temp15_new_downsample_train_full.log
