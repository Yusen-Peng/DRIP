#!/bin/bash
#SBATCH --job-name=May22_textVQA_LLaVA_7B_FLASH_finetune_ALL_ONCE_full
#SBATCH --output=May22_textVQA_LLaVA_7B_FLASH_finetune_ALL_ONCE_full.log
...
VERSION="LLaVA_7B_FLASH_finetune_ALL_ONCE_full"
