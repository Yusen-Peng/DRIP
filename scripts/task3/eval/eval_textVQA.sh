#!/bin/bash
#SBATCH --job-name=0722_textVQA_LLaVA_Qwen2.5-14B-Instruct_DRIP_10x_train_full
#SBATCH --output=0722_textVQA_LLaVA_Qwen2.5-14B-Instruct_DRIP_10x_train_full.log
