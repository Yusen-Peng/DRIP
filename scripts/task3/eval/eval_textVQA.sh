#!/bin/bash
#SBATCH --job-name=May22_textVQA_LLaVA_7B_Fixed_4x_finetune_train_full
#SBATCH --output=May22_textVQA_LLaVA_7B_Fixed_4x_finetune_train_full.log
...
VERSION="LLaVA_7B_Fixed_4x_finetune_train_full"
