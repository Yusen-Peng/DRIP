#!/bin/bash
#SBATCH --job-name=0621_textVQA_LLaVA_Qwen2.5-14B-Instruct_DRIP_4x_train_full
#SBATCH --output=0621_textVQA_LLaVA_Qwen2.5-14B-Instruct_DRIP_4x_train_full.log
