#!/bin/bash
#SBATCH --job-name=0702_MME_LLaVA_7B_SigLIP_HF_v2_Fixed_4x_train_full_FREE
#SBATCH --output=0702_MME_LLaVA_7B_SigLIP_HF_v2_Fixed_4x_train_full_FREE.log
...
VERSION="LLaVA_7B_SigLIP_HF_v2_Fixed_4x_train_full_FREE"
