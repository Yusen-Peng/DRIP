#!/bin/bash
#SBATCH --job-name=0628_MME_LLaVA_Qwen2.5-14B-Instruct_DRIP_4x_train_full
#SBATCH --output=0628_MME_LLaVA_Qwen2.5-14B-Instruct_DRIP_4x_train_full.log
...
python src/model_vqa_loader.py \
    --model-path /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_SigLIP_HF_finetune_full/checkpoint-990 \
