#!/bin/bash
#SBATCH --job-name=0722_VQAv2_LLaVA_7B_SigLIP_HF_v2_DRIP_4x_temp10_new_downsample_train_full
#SBATCH --output=0722_VQAv2_LLaVA_7B_SigLIP_HF_v2_DRIP_4x_temp10_new_downsample_train_full.log
