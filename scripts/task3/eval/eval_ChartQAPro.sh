#!/bin/bash
#SBATCH --job-name=0615_ChartQAPro_LLaVA_7B_DRIP_4x_ratio_ablation_train_full
#SBATCH --output=0615_ChartQAPro_LLaVA_7B_DRIP_4x_ratio_ablation_train_full.log
