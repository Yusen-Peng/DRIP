#!/bin/bash
#SBATCH --job-name=0702_ChartQAPro_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_train_full_temp001
#SBATCH --output=0702_ChartQAPro_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_train_full_temp001.log
