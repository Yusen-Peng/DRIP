#!/bin/bash
#SBATCH --job-name=0812_ChartQAPro_LLaVA_7B_DRIP_10x_SCALE_train_full-checkpoint-900
#SBATCH --output=0812_ChartQAPro_LLaVA_7B_DRIP_10x_SCALE_train_full-checkpoint-900.log
