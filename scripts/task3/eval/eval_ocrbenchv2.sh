#!/bin/bash
#SBATCH --job-name=0702_OCRBenchV2_LLaVA_Qwen2.5-14B-Instruct_train_full_PruneSID_10x
#SBATCH --output=0702_OCRBenchV2_LLaVA_Qwen2.5-14B-Instruct_train_full_PruneSID_10x.log
#SBATCH --time=3:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
