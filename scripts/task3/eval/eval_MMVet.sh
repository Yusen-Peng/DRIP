#!/bin/bash
#SBATCH --job-name=June2_MMVet_LLaVA_7B_FLASH_second_to_last_finetune_full_TRAIN_VIT
#SBATCH --output=June2_MMVet_LLaVA_7B_FLASH_second_to_last_finetune_full_TRAIN_VIT.log
...
# python src/model_vqa_loader.py \
#     --model-path /fs/scratch/PAS2836/yusenpeng_checkpoint/LLaVA_7B_DRIP_100x_finetune_train_lora \
