#!/bin/bash
#SBATCH --job-name=0617_MMVet_LLaVA_Qwen2.5-14B-Instruct_PruMerge_10x_train_full
#SBATCH --output=0617_MMVet_LLaVA_Qwen2.5-14B-Instruct_PruMerge_10x_train_full.log
