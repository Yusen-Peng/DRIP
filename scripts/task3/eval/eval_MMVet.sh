#!/bin/bash
#SBATCH --job-name=0628_MMVet_LLaVA_7B_FLASH_finetune_PruneSID_10x_full_second
#SBATCH --output=0628_MMVet_LLaVA_7B_FLASH_finetune_PruneSID_10x_full_second.log
