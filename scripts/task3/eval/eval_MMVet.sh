#!/bin/bash
#SBATCH --job-name=0812_MMVet_LLaVA_7B_Fixed_4x_SCALE_train_full-checkpoint-600
#SBATCH --output=0812_MMVet_LLaVA_7B_Fixed_4x_SCALE_train_full-checkpoint-600.log
