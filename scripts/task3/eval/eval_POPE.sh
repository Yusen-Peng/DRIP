#!/bin/bash
#SBATCH --job-name=0821_POPE_LLaVA_7B_DRIP_10x_pretrain_NEW_DOWN_temp10_train_full
#SBATCH --output=0821_POPE_LLaVA_7B_DRIP_10x_pretrain_NEW_DOWN_temp10_train_full.log
