#!/bin/bash
#SBATCH --job-name=0722_POPE_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_temp08_new_downsample_LEADING_ONE_train_full
#SBATCH --output=0722_POPE_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_temp08_new_downsample_LEADING_ONE_train_full.log
