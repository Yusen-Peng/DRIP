#!/bin/bash
#SBATCH --job-name=0812_POPE_LLaVA_7B_Fixed_4x_SCALE_train_full-checkpoint-300
#SBATCH --output=0812_POPE_LLaVA_7B_Fixed_4x_SCALE_train_full-checkpoint-300.log
