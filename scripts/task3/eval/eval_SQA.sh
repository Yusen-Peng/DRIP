#!/bin/bash
#SBATCH --job-name=0617_SQA_LLaVA_Qwen2.5-14B-Instruct_PruMerge_8x_train_full
#SBATCH --output=0617_SQA_LLaVA_Qwen2.5-14B-Instruct_PruMerge_8x_train_full.log
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
