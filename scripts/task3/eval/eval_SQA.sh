#!/bin/bash
#SBATCH --job-name=0821_SQA_LLaVA_Qwen2.5-14B-Instruct_DRIP_4x_pretrain_NEW_DOWN_temp001_train_full
#SBATCH --output=0821_SQA_LLaVA_Qwen2.5-14B-Instruct_DRIP_4x_pretrain_NEW_DOWN_temp001_train_full.log
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
