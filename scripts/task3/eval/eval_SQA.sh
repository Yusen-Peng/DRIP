#!/bin/bash
#SBATCH --job-name=June2_SQA_LLaVA_7B_FLASH_second_to_last_finetune_full_TRAIN_VIT
#SBATCH --output=June2_SQA_LLaVA_7B_FLASH_second_to_last_finetune_full_TRAIN_VIT.log
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
