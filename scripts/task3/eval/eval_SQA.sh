#!/bin/bash
#SBATCH --job-name=0812_SQA_LLaVA_7B_DRIP_10x_SCALE_train_full-checkpoint-900
#SBATCH --output=0812_SQA_LLaVA_7B_DRIP_10x_SCALE_train_full-checkpoint-900.log
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
