#!/bin/bash
#SBATCH --job-name=0812_SQA_LLaVA_7B_Fixed_4x_SCALE_train_full-checkpoint-300
#SBATCH --output=0812_SQA_LLaVA_7B_Fixed_4x_SCALE_train_full-checkpoint-300.log
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
