#!/bin/bash
#SBATCH --job-name=0722_SQA_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_temp10_new_downsample_train_full
#SBATCH --output=0722_SQA_LLaVA_7B_SigLIP_HF_v2_DRIP_10x_temp10_new_downsample_train_full.log
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
