#!/bin/bash
#SBATCH --job-name=May30_OCRBench_LLaVA_7B_FLASH_second_to_last_finetune_full
#SBATCH --output=May30_OCRBench_LLaVA_7B_FLASH_second_to_last_finetune_full.log
