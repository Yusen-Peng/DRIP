#!/bin/bash
#SBATCH --job-name=0821_MMMU_LLaVA_Qwen2.5-14B-Instruct_DRIP_10x_pretrain_NEW_DOWN_temp10_train_full
#SBATCH --output=0821_MMMU_LLaVA_Qwen2.5-14B-Instruct_DRIP_10x_pretrain_NEW_DOWN_temp10_train_full.log
