#!/bin/bash
#SBATCH --job-name=0702_wild_LLaVA_Qwen2.5-14B-Instruct_Perceiver_10x_train_full
#SBATCH --output=0702_wild_LLaVA_Qwen2.5-14B-Instruct_Perceiver_10x_train_full.log
