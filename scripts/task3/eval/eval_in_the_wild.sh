#!/bin/bash
#SBATCH --job-name=0702_wild_LLaVA_7B_SigLIP_HF_v2_DRIP_8x_temp08_new_downsample_train_full
#SBATCH --output=0702_wild_LLaVA_7B_SigLIP_HF_v2_DRIP_8x_temp08_new_downsample_train_full.log
