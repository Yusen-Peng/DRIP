...
try:
    import torch.utils.tensorboard as tensorboard # type: ignore
except ImportError:
    tensorboard = None
...
from open_clip_train_local.logger import setup_logging
from open_clip_train_local.params import parse_args
from open_clip_train_local.scheduler import cosine_lr, const_lr, const_lr_cooldown
from open_clip_train_local.train import train_one_epoch, evaluate
from open_clip_train_local.file_utils import pt_load, check_exists, start_sync_process, remote_sync
...
def main(args):
    ...
    if args.use_bnb_linear is not None:
        ...
        from open_clip_local.utils import replace_linear
    ...
    if 'train' not in data:
        ...
        if args.use_bnb_linear is not None:
            from open_clip_local.utils import convert_int8_model_to_inference_mode
