...
from torch.nn.parallel.distributed import DistributedDataParallel # type: ignore
...
from open_clip_local.model import DTPViT, HierarchicalDTPViT, SoftDTPViT, SingleAdaptedFixed
...
def train_one_epoch(model, data, loss, epoch, optimizer, scaler, scheduler, dist_model, args, tb_writer=None):
    ...
    use_boundary = isinstance(visual, DTPViT) or isinstance(visual, HierarchicalDTPViT) or isinstance(visual, SoftDTPViT) or isinstance(visual, SingleAdaptedFixed)
    if args.distill:
        dist_model.eval()
