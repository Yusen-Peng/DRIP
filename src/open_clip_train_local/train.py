...
def train_one_epoch(model, data, loss, epoch, optimizer, scaler, scheduler, dist_model, args, tb_writer=None):
    ...
    use_boundary = isinstance(visual, DTPViT) or isinstance(visual, HierarchicalDTPViT) or isinstance(visual, SoftDTPViT) or isinstance(visual, SingleAdaptedFixed) or isinstance(visual, SingleAdaptedSwin)
    if args.distill:
        dist_model.eval()
