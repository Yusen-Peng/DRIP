...
questions = loadFile("/fs/scratch/PAS2836/shared_LLaVA_eval/GQA/data/questions1/testdev_balanced_questions.json")
...
predictions = loadFile("/fs/scratch/PAS2836/shared_LLaVA_eval/GQA/data/testdev_balanced_predictions.json")
