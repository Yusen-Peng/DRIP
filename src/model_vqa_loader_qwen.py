...
def eval_model(args):
    ...
    print("im_end:", tokenizer.convert_tokens_to_ids("<|im_end|>"))
    print("endoftext:", tokenizer.convert_tokens_to_ids("<|endoftext|>"))
    ...
    for (input_ids, image_tensor, image_sizes), line in tqdm(zip(data_loader, questions), total=len(questions)):
        ...
        if args.debug:
            ...
            print("\n===== OUTPUT TOKENS =====")
            for i, tok in enumerate(output_ids[0].detach().cpu().tolist()):
                print(i, tok, repr(tokenizer.decode([int(tok)], skip_special_tokens=False)))
            print("\n===== DECODED OUTPUT =====")
            print(repr(tokenizer.decode(output_ids[0], skip_special_tokens=False)))
            exit()
