#!/bin/bash
#SBATCH --job-name=0826_OCRBenchv2_Qwen3VL_SFT_Fixed_4x_NEW_PIPELINE
#SBATCH --output=0826_OCRBenchv2_Qwen3VL_SFT_Fixed_4x_NEW_PIPELINE.log
...
# python eval_code/model_vqa_ocrbenchv2.py \
#     --model_path /fs/scratch/PAS2836/yusenpeng_checkpoint/Qwen3VL_SFT_DRIP_4x_NEW_PIPELINE_05xwidth \
#     --model_base Qwen/Qwen3-VL-4B-Instruct \
#     --dataset_path lmms-lab/OCRBench-v2 \
#     --dataset_split test \
#     --cache_dir /fs/scratch/PAS2836/yusenpeng_dataset/LLaVA_eval/ocrbenchv2 \
