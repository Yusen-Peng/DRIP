#!/bin/bash
#SBATCH --job-name=0826_textVQA_Qwen3VL_SFT_DRIP_4x_NEW_PIPELINE_1xwidth_3layers
#SBATCH --output=0826_textVQA_Qwen3VL_SFT_DRIP_4x_NEW_PIPELINE_1xwidth_3layers.log
