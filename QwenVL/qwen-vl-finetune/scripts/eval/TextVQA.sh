#!/bin/bash
#SBATCH --job-name=0826_textVQA_Qwen3VL_4B_Fixed_4x_checkpoint_12
#SBATCH --output=0826_textVQA_Qwen3VL_4B_Fixed_4x_checkpoint_12.log
...
VERSION="0826_textVQA_Qwen3VL_4B_Fixed_4x_checkpoint_12"
