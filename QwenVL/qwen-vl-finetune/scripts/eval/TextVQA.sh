#!/bin/bash
#SBATCH --job-name=0826_textVQA_Qwen3VL_SFT_PruneSID_4x_NEW_PIPELINE_transfer
#SBATCH --output=0826_textVQA_Qwen3VL_SFT_PruneSID_4x_NEW_PIPELINE_transfer.log
